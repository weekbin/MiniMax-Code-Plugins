 ...
 *
 * Four tabs — 概要 / 载荷·结果 / 计时 / Schema — each answering a different question
 * about the same record. Payload and result share one tab because the question that
 * matters is "what was sent, and what came back", which should not need a click back
 * and forth.
 */
